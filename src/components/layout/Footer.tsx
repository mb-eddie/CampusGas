        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4 text-sm leading-relaxed">
              The easiest way for university students and staff to get gas cylinder refills
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/gas-cylinders" className="hover:text-teal-500 transition">Gas Cylinders</Link>
              </li>
              <li>
                <Link to="/request-refill" className="hover:text-teal-500 transition">Request Refill</Link>
              </li>
              <li>
                <Link to="/my-orders" className="hover:text-teal-500 transition">My Orders</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="hover:text-teal-500 transition">Help Center</a>
              </li>
              <li>
                <a href="#" className="hover:text-teal-500 transition">Safety Information</a>
              </li>
              <li>
                <a href="#" className="hover:text-teal-500 transition">Refill Guide</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Campus Gas, University Road, Kampala</span>
              </li>
